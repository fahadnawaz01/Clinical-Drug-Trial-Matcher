...
function AssessmentResult({ assessment, onContactCoordinators, onDownloadReport }: AssessmentResultProps) {
  const [expandedSections, setExpandedSections] = useState<Set<string>>(new Set(['score']));

  console.log('🔍 AssessmentResult props:', { 
    hasContactHandler: !!onContactCoordinators, 
    hasDownloadHandler: !!onDownloadReport 
  });
  ...
  return (
    <div className="assessment-result">
      ...
      <div className="assessment-result__actions">
        <button 
          className="assessment-result__action-btn assessment-result__action-btn--primary"
          onClick={onContactCoordinators}
        >
        ...
        <button 
          className="assessment-result__action-btn assessment-result__action-btn--secondary"
